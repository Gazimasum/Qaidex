					...
					@else
						...
						<li class="nav-item dropdown no-arrow">
							...
							<ul id="userMenuDropdown" class="dropdown-menu user-menu dropdown-menu-right shadow-sm">
								...
								<li class="dropdown-item"><a href="{{ lurl('account/pending-approval') }}"><i class="icon-hourglass"></i> {{ t('Pending approval') }} <span class="badge badge-pill">
  								{{ isset($countPendingPosts) ? \App\Helpers\Number::short($countArchivedPosts) : 0 }}
  							</span></a></li>
