				...
				<div class="modal-body">
					...
					<div class="form-group">
						...
						<div class="input-icon">
							...
							<input id="mLogin" name="login" required type="email" placeholder="{{ getLoginLabel() }}" class="form-control{{ $loginError }}" value="{{ $loginValue }}">
						</div>
					</div>
					...
					<div class="form-group">
						...
						<div class="input-icon">
							...
							<input id="mPassword" name="password" required type="password" class="form-control{{ $passwordError }}" placeholder="{{ t('Password') }}" autocomplete="off">
						</div>
					</div>
