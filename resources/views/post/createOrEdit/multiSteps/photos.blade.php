                                    ...
                                    <fieldset>
                                            ...
                                            <div id="picturesBloc" class="form-group row">
												...
												<div class="col-md-12 text-center pt-2" style="position: relative; float: {!! (config('lang.direction')=='rtl') ? 'left' : 'right' !!};">
													<div {!! (config('lang.direction')=='rtl') ? 'dir="rtl"' : '' !!} class="file-loading">
														<input id="pictureField" required name="pictures[]" type="file" multiple class="file picimg{{ $picturesError }}">
													</div>
                                        ...
                                        <div class="form-group row mt-4">
                                            <div class="col-md-12 text-center">
                                                ...
                                                @endif
                                                  <a id="nextStepAction" style="display:none" href="{{ url($nextStepUrl) }}" class="btn btn-default btn-lg">{{ t('Next') }}</a>
                                              </div>
                                        </div>
...
@section('after_scripts')
    ...
    <script>
        ...
        $('#pictureField').on('filebatchuploadsuccess', function(event, data, previewId, index) {
            ...
            // $("#nextStepAction").html('{{ $nextStepLabel }}').removeClass('btn-default').addClass('btn-primary').show();
