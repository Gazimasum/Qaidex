								...
								<form class="form-horizontal" id="postForm" method="POST" action="{{ url()->current() }}" enctype="multipart/form-data">
									...
									<fieldset>
										...
										<div class="form-group row required">
											...
											<div class="col-md-8">
												<select name="parent_id" required id="parentId" class="form-control selecter{{ $parentIdError }}">
												...
												<input type="hidden" required name="parent_type" id="parentType" value="{{ old('parent_type') }}">
											</div>
										</div>
										...
										<div id="subCatBloc" class="form-group row required">
											...
											<div class="col-md-8">
												<select name="category_id" required id="categoryId" class="form-control selecter{{ $categoryIdError }}">
													<option value="0" data-type=""
										...
										<div class="form-group row required">
											...
											<div class="col-md-8">
												<input id="title" name="title" required placeholder="{{ t('Ad title') }}" class="form-control input-md{{ $titleError }}"
										...
										@if (empty(config('country.code')))
											<div class="form-group row required">
												...
												<div class="col-md-8">
													<select id="countryCode" name="country_code" required class="form-control sselecter{{ $countryCodeError }}">
										...
										*/
										...
										@if (config('country.admin_field_active') == 1 and in_array(config('country.admin_type'), ['1', '2']))
											...
											<div id="locationBox" class="form-group row required">
												...
												<div class="col-md-8">
													<select id="adminCode" required name="admin_code" required class="form-control sselecter{{ $adminCodeError }}">
										...
										<div id="cityBox" class="form-group row required">
											...
											<div class="col-md-8">
												<select id="cityId"  name="city_id" required class="form-control sselecter{{ $cityIdError }}">
										...
										@else
											<div class="form-group row required">
												...
												<div class="col-md-8">
													<input id="contact_name" required name="contact_name" placeholder="{{ t('Your name') }}"
