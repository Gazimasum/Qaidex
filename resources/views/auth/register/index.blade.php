								...
								<form id="signupForm" class="form-horizontal" method="POST" action="{{ url()->current() }}">
									...
									<fieldset>
										...
										<div class="form-group row required">
											...
											<div class="col-md-6">
												<input name="name" placeholder="{{ t('Name') }}" required class="form-control input-md{{ $nameError }}" type="text" value="{{ old('name') }}">
											</div>
										</div>
										...
										@if (empty(config('country.code')))
											...
											<div class="form-group row required">
												...
												<div class="col-md-6">
													<select id="countryCode" required name="country_code" class="form-control sselecter{{ $countryCodeError }}">
